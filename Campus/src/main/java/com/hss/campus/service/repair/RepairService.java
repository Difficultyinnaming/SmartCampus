...
public interface RepairService {
    ...
    //更新维修进度
    boolean modifyStatus(String status, Integer id);
    //更新维修进度，评价，描述
    boolean modifyAppraiseRepair(String schedule, String appraise, String description, Integer repairId);
    //派遣维修工
    boolean addSendWorker(String name, Integer repairId);
    //今日报修数量
    ...
    //获取全部区域的订单数量
    Long queryRepairNum(String area, String schedule);
    Long queryRepairOtherNum(String area, String schedule1, String schedule2, String schedule3);
    ...
    String queryUnitNameByRepairId(Integer id);
}
